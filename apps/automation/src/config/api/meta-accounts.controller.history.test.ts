...
function make(over: any = {}) {
  ...
  // Constructor order: accounts, graph, env, history, insights
  return new MetaAccountsController(accounts as any, graph as any, env as any, history as any, insights as any);
}
